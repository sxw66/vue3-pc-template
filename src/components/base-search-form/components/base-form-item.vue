<template>
  ...
  <el-form-item v-else-if="config.valueType === 'select'" :label="config?.label" style="width: 100%">
  ...
  <el-form-item v-else-if="config.valueType === 'date-picker'" :label="config?.label" style="width: 100%">
